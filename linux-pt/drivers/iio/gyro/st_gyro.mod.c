...
__attribute__((section("__versions"))) = {
	...
	{ 0xb9972fc5, __VMLINUX_SYMBOL_STR(st_sensors_set_fullscale_by_gain) },
	...
	{ 0x68435e86, __VMLINUX_SYMBOL_STR(st_sensors_sysfs_scale_avail) },
	{ 0x603f80c5, __VMLINUX_SYMBOL_STR(st_sensors_set_axis_enable) },
