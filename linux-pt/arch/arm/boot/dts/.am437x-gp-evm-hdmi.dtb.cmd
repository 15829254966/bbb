cmd_arch/arm/boot/dts/am437x-gp-evm-hdmi.dtb := mkdir -p arch/arm/boot/dts/ ; arm-linux-gnu-gcc -E -Wp,-MD,arch/arm/boot/dts/.am437x-gp-evm-hdmi.dtb.d.pre.tmp -nostdinc -I./arch/arm/boot/dts -I./arch/arm/boot/dts/include -I./drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/boot/dts/.am437x-gp-evm-hdmi.dtb.dts.tmp arch/arm/boot/dts/am437x-gp-evm-hdmi.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm/boot/dts/am437x-gp-evm-hdmi.dtb -b 0 -i arch/arm/boot/dts/ -@ -Wno-unit_address_vs_reg -d arch/arm/boot/dts/.am437x-gp-evm-hdmi.dtb.d.dtc.tmp arch/arm/boot/dts/.am437x-gp-evm-hdmi.dtb.dts.tmp ; cat arch/arm/boot/dts/.am437x-gp-evm-hdmi.dtb.d.pre.tmp arch/arm/boot/dts/.am437x-gp-evm-hdmi.dtb.d.dtc.tmp > arch/arm/boot/dts/.am437x-gp-evm-hdmi.dtb.d
...
deps_arch/arm/boot/dts/am437x-gp-evm-hdmi.dtb := \
  ...
  arch/arm/boot/dts/include/dt-bindings/sound/sii9022-audio.h \
