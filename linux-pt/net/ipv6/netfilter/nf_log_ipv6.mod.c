...
__attribute__((section("__versions"))) = {
	...
	{ 0xb2e9a592, __VMLINUX_SYMBOL_STR(nf_log_dump_udp_header) },
	{ 0xd10a0023, __VMLINUX_SYMBOL_STR(nf_log_dump_sk_uid_gid) },
	{ 0x7f6ef548, __VMLINUX_SYMBOL_STR(nf_log_dump_tcp_header) },
